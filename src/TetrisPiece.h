...
public:
	...
	//reposition should (forseeabley) only be used by the board to move the
	//piece to the top of the board.
	 ...
	 *
	 * @return A vector which contains copies of
	 * the current positions of the blocks.
	 */
	 ...
	 *
	 * @return The lowest X value that the piece's blocks have.
	 */
	int getLeft();
	 ...
	 *
	 * @return The highest X value that the piece's blocks have.
	 */
	int getRight();
	 ...
	 *
	 * @return The lowest Y value that the piece's blocks have.
	 */
	int getBottom();
	 ...
	 *
	 * @return The highest Y value that the piece's blocks have.
	 */
	int getTop();

	// this will mainly be used for testing, and should be deleted when done
	/**
...
private:
	...
	//pieces are immutable so this private constructor handles rotation
	/**
